...
def test_badger_orion_volume_gal_discovery(monkeypatch):
    ...
    cfg = last_discovery_payload(
        c, domain="sensor", unique_id_with_suffix="rtl433_Badger-ORION_deadbeef_volume_gal_T"
    )
...
def test_neptune_r900_meter_reading_uses_gallons(monkeypatch):
    ...
    cfg1 = last_discovery_payload(
        c, domain="sensor", unique_id_with_suffix="rtl433_Neptune-R900_deadbeef_meter_reading_T"
    )
